...
void setup()
{
  ...
  //myGNSS.enableDebugging(SerialUSB); // Uncomment this line to enable debug messages
  ...
  if (sizeof(double) < 8)
  {
    SerialUSB.println(F("Warning! Your platform does not support 64-bit double."));
    SerialUSB.println(F("The latitude and longitude will be inaccurate."));
  }
...
void loop()
{
  ...
  if (millis() - lastTime > 1000)
  {
   ...
   // Print the lat and lon
    SerialUSB.print("Lat (deg): ");
    SerialUSB.print(d_lat, 9);
    SerialUSB.print(", Lon (deg): ");
    SerialUSB.print(d_lon, 9);
    ...
    SerialUSB.print(", Ellipsoid (m): ");
    SerialUSB.print(f_ellipsoid, 4); // Print the ellipsoid with 4 decimal places

    SerialUSB.print(", Mean Sea Level (m): ");
    SerialUSB.print(f_msl, 4); // Print the mean sea level with 4 decimal places

    SerialUSB.print(", Accuracy (m): ");
    SerialUSB.println(f_accuracy, 4); // Print the accuracy with 4 decimal places
  }
}
